...
要提一点的是，国内的话可能更熟悉阿里的开发手册[📎Java开发手册（嵩山版）.pdf](https://www.yuque.com/attachments/yuque/0/2022/pdf/12423125/1642496086731-e0491cc2-72c4-44d0-a4db-8bf1e3591aa0.pdf)

或者《Effective Java》 （Gitee：[https://gitee.com/lin-mt/effective-java-third-edition](https://gitee.com/lin-mt/effective-java-third-edition) 
...
本文档中的示例代码**是非规范的**。也就是说，虽然这些示例采用 Google 风格，但它们可能**无法说明表示代码的唯一时尚方式**。示例中的可选格式选择**不应作为规则强制执行**。（不强制你使用这种规范）
