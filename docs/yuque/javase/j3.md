...
* 栈的入口、出口的都是栈的顶端位置。
  ...
  ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/12.png)
...
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/13.png)
...
* 查找元素快：通过索引，可以快速访问指定位置的元素
   ...
   ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/14.png)

* 增删元素慢
* **指定索引位置增加元素**：需要创建一个新数组，将指定新元素存储在指定索引位置，再把原数组元素根据索引，复制到新数组对应索引的位置。如下图

![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/15.png)

* **指定索引位置删除元素：**需要创建一个新数组，把原数组元素根据索引，复制到新数组对应索引的位置，原数组中指定索引位置元素不复制到新数组中。如下图

![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/16.png)

总结
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/17.bmp)
...
* **链表**:**linked list**,由一系列结点node（链表中每一个元素称为结点）组成，结点可以在运行时i动态生成。每个结点包括两个部分：一个是存储数据元素的数据域，另一个是存储下一个结点地址的指针域。我们常说的链表结构有单向链表与双向链表，那么这里给大家介绍的是**单向链表**。
  ...
  ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/18.png)

简单的说，采用该结构的集合，对元素的存取有如下的特点：

* 多个结点之间，通过地址进行连接。例如，多个人手拉手，每个人使用自己的右手拉住下个人的左手，依次类推，这样多个人就连在一起了。

  ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/19.png)
...
* 增删元素快：
  ...
  *  增加元素：只需要修改连接下个元素的地址即可。
    ...
    ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/20.png)

  *  删除元素：只需要修改连接下个元素的地址即可。

    ![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/21.bmp)
...
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/22.bmp)
...
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/23.png)
...
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/24.bmp)
...
![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/25.png)

看到这张图就有人要问了，这个是怎么存储的呢？

为了方便大家的理解我们结合一个存储流程图来说明一下：

![](https://unleashed.oss-cn-beijing.aliyuncs.com/picgo/26.png)
